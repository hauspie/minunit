...
MU_SETUP(half_success) {}
MU_TEAR_DOWN(half_success) {}
MU_TEST(half_success, success1) { MU_ASSERT_EQUAL(0, 0);}
MU_TEST(half_success, success2) { MU_ASSERT_NOT_EQUAL(1, 0); }
MU_TEST(half_success, fail1) { MU_ASSERT_EQUAL(0,1); }
MU_TEST(half_success, fail2) { MU_ASSERT_NOT_EQUAL(0,0); }
...
MU_SETUP(test_assertions) {}
MU_TEAR_DOWN(test_assertions) {}
